// Ghostty embedding API header — copied from github.com/ghostty-org/ghostty
// Update this file from your local Ghostty source if API changes occur.
#ifndef GHOSTTY_H
#define GHOSTTY_H
...
bool ghostty_surface_read_last_output(ghostty_surface_t, ghostty_text_s*);
